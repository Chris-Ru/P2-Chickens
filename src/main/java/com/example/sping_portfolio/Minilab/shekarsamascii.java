...
import com.example.sping_portfolio.Minilab.shekarsamascii;
import java.awt.*;
import java.awt.image.BufferedImage;
import java.io.File;
import java.util.Scanner;

public class shekarsamascii {
    public static final int ART_SIZE_LARGE = 20;
    private static final String DEFAULT_ART_SYMBOL = "X";
    ...
    public static void main(String[] args) throws Exception {
        shekarsamascii artGen = new shekarsamascii();

        System.out.println();
        Scanner sc= new Scanner(System.in); //System.in is a standard input stream
        artGen.printTextArt("shekar", shekarsamascii.ART_SIZE_LARGE);
        System.out.println();
     ...
     * @throws Exception
     */
    private void printTextArt(String artText, int textHeight, shekarsamascii.ASCIIArtFont fontType, String artSymbol) throws Exception {
    ...
    private void printTextArt(String artText, int textHeight) throws Exception {
        printTextArt(artText, textHeight, shekarsamascii.ASCIIArtFont.ART_FONT_DIALOG, DEFAULT_ART_SYMBOL);
    }
