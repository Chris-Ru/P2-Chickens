package com.example.sping_portfolio.Minilab.Chris_Dylan_ascii;
...
public final class asciipic {
    ...
    public asciipic(final boolean negative) {
            ...
            public void run() {
                ...
                while (fileChooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
                    try {
                        ...
                        final String ascii = new asciipic().convert(image);
                        ...
                        final JDialog dialog = new JOptionPane(new JScrollPane(textArea), JOptionPane.PLAIN_MESSAGE).createDialog(asciipic.class.getName());
